...
output_to_manifest() {
  ...
  for img_path in "${images[@]}"; do
    img_name="${img_path##*/}"
    text="{\"source-ref\":\"s3://$bucket_name/$class/$img_name\",\"anomaly-label\":$label,\"anomaly-label-metadata\":{\"confidence\":1,\"class-name\":\"$class\",\"human-annotated\":\"yes\",\"creation-date\":\"2021-04-06T19:18:44.208156\",\"type\":\"groundtruth/image-classification\"}}"
